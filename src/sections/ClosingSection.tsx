      ...
      <div ref={pinRef} className="h-screen w-full relative">
        ...
        <div className="relative z-10 h-full flex items-center justify-center px-8 md:px-[8vw]">
          <div className="max-w-4xl text-center perspective-1000">
            ...
            >
              {t('Οι ιστορίες ξεκινούν', 'Stories always start')}
              <br />
              {t('πάντα από μια συζήτηση.', 'with a conversation.')}
              <br />
              <span className="text-3xl md:text-5xl font-medium text-zinc-200">
                {t('Ας είναι αυτή η πρώτη.', 'Let this be the first one.')}
              </span>
            </h2>
            ...
            <div ref={ctaRef} className="flex flex-wrap justify-center gap-4">
              <a href="#work" className="btn-primary">
                {t('Δες τη δουλειά μας', 'View our work')}
              </a>
              <a href="#contact" className="btn-secondary">
                {t('Επικοινώνησε', 'Contact us')}
              </a>
            </div>
          </div>
        </div>
